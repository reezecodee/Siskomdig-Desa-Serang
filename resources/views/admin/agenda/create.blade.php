        ...
        <div class="card">
            <div class="card-body">
                <div class="row mb-3">
                    <div class="col-md-12">
                        <div class="form-group mb-2">
                            ...
                            @enderror"
                                value="{{ old('judul_agenda') }}" autocomplete="off"
                    ...
                    <div class="col-md-4">
                        <div class="form-group mb-2">
                            ...
                            @enderror"
                                value="{{ old('tgl_pelaksanaan') }}" autocomplete="off"
                                placeholder="Masukkan tanggal pelaksanaan agenda kegiatan" required>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            @enderror" autocomplete="off"
                                placeholder="Masukkan keterangan agenda kegiatan" required>{{ old('keterangan') }}</textarea>
                            @error('keterangan')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
                ...
                <div class="d-flex justify-content-end">
                    <button class="btn btn-primary" type="button" onclick="confirmAlert('form-create')"><svg class="icon"
