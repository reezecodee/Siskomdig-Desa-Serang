...
@section('content')
    ...
    <div class="container-fluid page-header py-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container text-center py-5">
            <h1 class="display-2 text-white mb-4">Anggota Komunitas</h1>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb justify-content-center mb-0">
                    <li class="breadcrumb-item"><a href="javascript:void(0)">Mitra Komunitas</a></li>
                    <li class="breadcrumb-item text-white" aria-current="page">Anggota Komunitas</li>
                </ol>
            </nav>
        </div>
    </div>
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3 wow fadeInUp" data-wow-delay="0.3s">
                            <div class="team-item border rounded shadow-sm overflow-hidden">
                                ...
                                <div class="team-content text-center p-3 bg-light">
                                    ...
                                    <p class="text-muted small mb-0">{{ $item->businessFields->nama_bidang_usaha }}</p>
                                </div>
                            </div>
                        </div>
                    @endforeach
