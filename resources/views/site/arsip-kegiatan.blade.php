        ...
        <div class="container py-5">
            <div class="text-start mx-auto pb-5 wow fadeInUp" data-wow-delay="0.2s" style="max-width: 1100px;">
                ...
                <div class="d-flex gap-4 align-items-center mb-4">
                    ...
                    <div>
                        <h4 class="fw-bold">Rapat pembahasan rencana peningkatan stok pupuk pada bulan Oktober 2024
                            bersama pelaku UMKM</h4>
                        <p class="fw-light">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod
